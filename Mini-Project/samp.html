...
<body>
    ...
    <section class="home" id="home">
        <div class="home-text">
            ...
            <a href='http://localhost/IP%20Project/components/menu_page/menu.php' class="btn">View Menu</a>
        </div>
        <div class="home-img">
    ...
    <section class="contact" id="contact">
        ...
        <div class="contact-box">
            ...
            <li><a href="#Ter ms Of Use">Terms Of Use</a></li>
        </div>
    ...
    <div>
        <div id="loginModal" class="popup-container">
            <div class="popup-content">
                <span class="close" id="close">&times;</span>
                <h2>Login</h2>
                <form action="loginData_Update.php" method="POST"> <!-- Point to the PHP login script -->
                    <label for="phoneNo">Mobile Number</label>
                    <input type="text" id="phoneNo" name="mobile_number" maxlength="10" required> <!-- Added name attribute -->
                    <button id="validPho" type="submit" disabled>Login</button> <!-- Changed button text -->
                </form>
            </div>
        </div>
    </div>
